...
view_type = "question"
metabase_graphics = [{'id':1, 'url':get_metabase_url(view_type, 14)},
                    {'id':2, 'url':get_metabase_url(view_type, 15)},
                    {'id':3, 'url':get_metabase_url(view_type, 16)},
                    {'id':4, 'url':get_metabase_url(view_type, 17)}]

def index(request):
    return render(request, 'events_indicators/events_indicators.html', {'metabase_graphics':metabase_graphics})
