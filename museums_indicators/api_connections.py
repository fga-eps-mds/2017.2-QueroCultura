...
class RequestMuseumRawData(object):
    def __init__(self, last_update_time):
        ...
        self._filters = {'@select' : 'mus_tipo, mus_tipo_tematica, En_Estado, esfera, mus_servicos_visitaGuiada, mus_arquivo_acessoPublico, createTimestamp', 'createTimestamp' : "GT("+self._get_time+")"}
