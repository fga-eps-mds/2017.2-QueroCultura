...
class RequestLibraryRawData(object):
    def __init__(self, last_update_time):
        ...
        self._filters = {'@select' : 'En_Estado, esfera, esfera_tipo, terms', 'createTimestamp' : "GT("+self._get_time.__str__()+")"}
...
museu = RequestLibraryRawData(get_time)
print(museu.response.url)
