...
function getSpace(){	
	...
	var getTimeNow = new Date();
	    getTimeNow.setHours(getTimeNow.getHours() - 10, getTimeNow.getMinutes()-1);
	    ...
	    var greenMarker = L.icon({
	    	iconUrl: "static/images/lnfsd.gif",
	    	iconSize: [20,20],
	    });
	    ...
	    promise.then(function(data) {
            ...
            for(var i=0; i < data.length; i++){
            	...
            	var marker = L.marker([data[i]["location"]["latitude"], data[i]["location"]["longitude"]], {icon: greenMarker}).addTo(markers);
